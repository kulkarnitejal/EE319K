...
const uint16_t Test2[] = {
  ...
  0x07E0, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF,
  0x07E0, 0x07E0, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0x07E0,
  0xFFFF, 0x07E0, 0x07E0, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0x07E0, 0x07E0,
	0xFFFF, 0xFFFF, 0x07E0, 0x07E0, 0xFFFF, 0xFFFF, 0xFFFF, 0x07E0, 0x07E0, 0xFFFF,
  0xFFFF, 0xFFFF, 0xFFFF, 0x07E0, 0x07E0, 0xFFFF, 0x07E0, 0x07E0, 0xFFFF, 0xFFFF,
  0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0x07E0, 0xFFFF, 0x07E0, 0xFFFF, 0xFFFF, 0xFFFF,
  0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0x07E0, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF,
...
int main(void){  
 ...
 ST7735_InitR(INITR_REDTAB);
  ...
  for(i=0;i<SIZE;i++){
	...
	ST7735_FillScreen(0xFFFF);   								// set screen to white
	ST7735_DrawCircle(54, 80,0x001F);						//Draw first cherry (RED)
	ST7735_DrawCircle(66, 80,0xF81F);						//Draw first cherry (Magenta)
	ST7735_DrawBitmap(59,80,Test2,10,7);				//Draw green stalk
	IO_Touch();
